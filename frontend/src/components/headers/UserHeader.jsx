        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
            ...
            >
              ...
              {profileOpen && (
                <div className="absolute left-0 mt-3 w-44 bg-black border border-neutral-800 rounded-md shadow-lg">
                  <div className="px-4 py-2 text-xs text-white/50 border-b border-neutral-800">
                    {user?.name}
                  </div>

                  <NavLink
                    to="/analytics"
                    className="block px-4 py-2 text-sm text-white/80 hover:text-white hover:bg-neutral-900"
                  >
                    Analytics
                  </NavLink>
